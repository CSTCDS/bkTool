...
$where = [];
$params = [];
if (!empty($_GET['account'])) { $where[] = 'account_id = :account'; $params[':account'] = $_GET['account']; }
...
<h1>Transactions</h1>
<form method="get">
    <label>Account: <input name="account" value="<?php echo htmlspecialchars($_GET['account'] ?? ''); ?>"></label>
